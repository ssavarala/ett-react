...
import SendDirectMessage from './Components/SendDirect';
            ...
            <Navbar bg="dark" variant="dark" expand="sm">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        ...
                        <Nav.Link as={NavLink} to="/direct">Send Direct</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Navbar>
            <Switch>
                ...
                <Route exact path='/direct' component={SendDirectMessage} />
